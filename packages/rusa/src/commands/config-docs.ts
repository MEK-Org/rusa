...
github:
  ...
  repos                    Optional list. GitHub repositories in owner/name format defining operating scope.
  orgs                     Optional list. GitHub organization names (or objects with org and optional excludedRepos) defining operating scope.
