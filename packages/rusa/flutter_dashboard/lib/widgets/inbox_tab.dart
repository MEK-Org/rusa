          ...
          return ListView(
            ...
            children: [
              ...
              if (pending.isNotEmpty) ...[
                _SectionTitle('Outstanding inbox signals', '${pending.length} pending'),
          ...
          if (handled) ...[
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                border: Border(left: BorderSide(color: MeshColors.statusActive, width: 2)),
              ),
              child: Column(
                ...
                children: [
                  ...
                  if (e['handledNote']?.toString().trim().isNotEmpty == true)
                    RichText(
                      text: TextSpan(
                        style: const TextStyle(color: Color(0xFFC8DED7), fontSize: 12.5, height: 1.45),
                        children: [
                          const TextSpan(text: 'Addressed: ', style: TextStyle(fontWeight: FontWeight.w700)),
...
class _SectionTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Row(children: [
          ...
          Text(detail, style: const TextStyle(color: MeshColors.textMuted, fontSize: 12)),
          if (action != null) ...[
            const SizedBox(width: 8),
            action!,
          ],
