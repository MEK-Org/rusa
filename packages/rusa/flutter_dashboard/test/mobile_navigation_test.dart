...
Widget _app(DashboardStore store) => MaterialApp(
...
void main() {
  ...
  testWidgets('quota sits at the bottom of the drawer, below every destination',
      (tester) async {
    await tester.runAsync(() async {
  ...
  testWidgets('a phone detail view swaps the hamburger for a back arrow and '
    ...
    await tester.runAsync(() async {
      ...
      final headerBottom = tester
          .getBottomLeft(find.byType(MeshHeader))
          .dy;
      expect(
